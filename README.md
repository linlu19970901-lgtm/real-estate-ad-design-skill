...
- **色彩按场景判断**：红金不是禁用色；春节、中式、喜报和品牌庆典可采用红金，但必须控制主次、比例与真实工艺质感。
- **不把高级等同于极简灰调**：人物、夜景、高饱和、繁复装饰和强商业视觉均可进入首推，依据项目与传播目标判断。
- **字体不制造版权风险**：不默认推荐付费商用字体，改用字形类别、字宽、字重、笔画、字距和中英文关系等可执行描述。
- **首稿即图文一体**：标题、案名、卖点、时间与Logo位从构图阶段进入画面，不把无字背景和排版拆成两次交付。
