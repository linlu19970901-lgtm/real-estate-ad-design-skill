...
An AI skill for Chinese real-estate advertising and property marketing. It turns incomplete briefs and vague feedback into production-ready visual directions for designers and image-generation tools.
...
Install or copy this directory into an agent environment that supports `SKILL.md`, then ask:

```text
Use the Real Estate Ad Design Skill to create three production-ready naming-launch key visual directions for an urban waterfront residence. We have an official building render and logo. Avoid black-and-gold clichés and large blue-sky water panoramas.
```
